            ...
            <div className="glass-card p-6 max-w-sm mx-auto">
                ...
                <div className="space-y-3 mb-6">
                    ...
                    <div className="space-y-2">
                        <label htmlFor="payment-ton" className="flex items-center gap-3 p-3 rounded-lg border border-blue-600 cursor-pointer hover:bg-blue-800/30 bg-blue-900/20">
                            <input
                                id="payment-ton"
                                type="radio"
                                name="payment-method"
                        ...
                        <label htmlFor="payment-uzcard" className="flex items-center gap-3 p-3 rounded-lg border border-gray-600 cursor-pointer hover:bg-gray-800/50">
                            <input
                                id="payment-uzcard"
                                type="radio"
                                name="payment-method"
                        ...
                        <label htmlFor="payment-humo" className="flex items-center gap-3 p-3 rounded-lg border border-gray-600 cursor-pointer hover:bg-gray-800/50">
                            <input
                                id="payment-humo"
                                type="radio"
                                name="payment-method"
