...
const FriendsList = ({ user, handleInviteFriend }) => {
  ...
  const handleInviteClick = () => {
    ...
    if (WebApp) {
      ...
      const shareText = `🏙️ DUBAI CITY - Millioner Bo'lish Vaqti Keldi! 💰
      
🔥 Mening bilan birga DUBAI imperiyasini quraylik!
💎 Har kuni millionlab coin ishlang
🚀 Bizneslarga sarmoya qiling va boyib keting
🎁 Qo'shilsangiz 3000 BEPUL coin!

👑 Eng zo'r o'yinchi bo'lib, do'stlaringizni mag'lub eting!`;
