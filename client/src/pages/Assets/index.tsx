...
const Assets = (props) => {
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white relative overflow-hidden flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto px-3 sm:px-4 pb-20 sm:pb-24" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="flex space-x-1">
                            <button 
                              onClick={() => {
                                // Forward to Telegram
                                const promoText = `🎉 Tabriklaymiz! 
                                
Sizga Uzum Market uchun 200,000 so'm chegirma!

💰 1 mln so'mlik harid uchun 200,000 so'm chegirma
🎁 Promo kod: ${promo.code || 'UZUM2024'}

🔥 Foydalanish uchun: @DubaiCITY_robot`;
                            ...
                            <button 
                              onClick={() => {
                                ...
                                // Enhanced copy with multiple fallback methods
                                const copyToClipboard = async () => {
                                  try {
                                    if (navigator.clipboard && window.isSecureContext) {
                                      await navigator.clipboard.writeText(textToCopy);
                                      notifier.addNotification('Promo kod nusxalandi!', 'success');
                                    } else {
                                    ...
                                    alert(`Promo kod: ${textToCopy}\n\nQo'lda nusxalang!`);
                                    notifier.addNotification('Promo kod ko\'rsatildi!', 'info');
                                  }
                                };
