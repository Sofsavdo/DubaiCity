...
const Birja = ({ user, setUser, exchangeRate, handleUpdateHistory }) => {
    ...
    // Narxni yangilab turish uchun useEffect - har sekundda
    useEffect(() => {
        const priceInterval = setInterval(() => {
            setPriceData(prevData => {
                ...
                // Update live price display in parent
    ...
    return (
        <div className="p-2 z-10 relative flex flex-col h-full max-h-[calc(100vh-240px)]">
            {/* Fixed Chart Section */}
            <div className="flex-shrink-0">
                {/* Kattalashtrilgan Chart */}
                <div className="w-full h-32 rounded-lg overflow-hidden bg-gray-800/50 border border-gray-600 p-1 relative mb-1">
                ...
                {/* Tablar */}
                <div className="bg-gray-800/50 border border-gray-600 rounded-lg p-1 flex mt-1">
            ...
            <div className="flex-1 mt-1 overflow-y-auto" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
                {historyTab === 'active' && (
                    <div className="space-y-1">
                        <div className="bg-gray-800/50 border border-gray-600 rounded-lg p-2 text-xs text-gray-400 flex justify-between sticky top-0 z-10">
