...
export const MarketIcon = (props) => (
  <motion.svg
    ...
    {...props}
  >
    <path d="M7 4V2a1 1 0 011-1h8a1 1 0 011 1v2h4a1 1 0 011 1v2a1 1 0 01-1 1h-1.28l-.5 8.5A2 2 0 0117.22 19H6.78a2 2 0 01-2-1.5L4.28 8H3a1 1 0 01-1-1V5a1 1 0 011-1h4zm2 0h6V3H9v1zm8.22 4H6.78l.5 8h9.44l.5-8z" />
  </motion.svg>
);
...
export const TeamIcon = (props) => (
  ...
  >
    ...
    <path d="M6 7a2 2 0 11-4 0 2 2 0 014 0zM22 7a2 2 0 11-4 0 2 2 0 014 0z" />
    <path d="M4 19a5 5 0 00-4 4h8a5 5 0 00-4-4zM24 19a5 5 0 00-4 4h8a5 5 0 00-4-4z" />
  </motion.svg>
);
