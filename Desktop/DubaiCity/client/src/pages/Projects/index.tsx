...
const Projects = ({
  ...
  return (
    <div className="flex flex-col h-screen bg-gradient-to-b from-gray-900 to-black pb-20 sm:pb-24">
      {/* Header */}
      ...
      {/* Content */}
      <div className="flex-1 overflow-y-auto px-4 pb-4 mt-2" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
